...
final class MessageGenerator
{
    ...
    public static function monstersDetectedWithoutMonDef(): string
    {
    ...
    public static function areaNotAvailable(): string
    {
    ...
    {
        return '{"t":"xt","b":{"r":-1,"o":{"cmd":"getQuests","quests":{"7165":{"QuestID":7165,"sName":"Member Quest","sDesc":"A quest for members only.","sEndText":"Well done!","iExp":500,"iGold":1000,"iRep":0,"FactionID":1,"sFaction":"Good","iLvl":30,"iReqRep":5,"iReqCP":10,"iClass":42,"bOnce":1,"bUpg":1,"bStaff":0,"bGuild":0,"turnin":[],"reward":[],"reqd":[]}}}}}';
    }
