...
final class PlayerDetectedEventTest extends TestCase
{
    ...
    {
        $event = PlayerDetectedEvent::from(DelimitedMessage::from(
        ...
        $event = PlayerDetectedEvent::from(DelimitedMessage::from('%xt%exitArea%-1%1128%aejax%'));
    ...
    {
        $event = PlayerDetectedEvent::from(JsonMessage::from(
