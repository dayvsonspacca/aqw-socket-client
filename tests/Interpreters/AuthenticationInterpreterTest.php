...
namespace AqwSocketClient\Tests\Interpreters;
...
{
    private readonly AuthenticationInterpreter $interpreter;
    ...
    {
        $message = XmlMessage::fromString('<cross-domain-policy><allow-access-from domain="*" to-ports="*"/></cross-domain-policy>');
    ...
    public function should_return_login_responded_event_on_login_response(): void
    {
        ...
        $this->assertSame(43472, $events[0]->socketId);
    }
