...
class ShopInterpreterTest extends TestCase
{
    ...
    public function should_interpreter_loaded_shop_event(): void
    {
        $message = JsonMessage::fromString(
            '{"t":"xt","b":{"r":-1,"o":{"shopinfo":{"bUpgrd":"0","items":[{"ItemID":"47482","sFaction":"None","iClass":"0","sElmt":"None","sLink":"ULS","bStaff":"0","iRng":"10","iDPS":"100","bCoins":"1","sES":"co","sType":"Armor","iCost":750,"iRty":"13","iQty":1,"sIcon":"iwarmor","iLvl":"1","FactionID":"1","bTemp":"0","iQtyRemain":"-1","iReqRep":"0","iQSvalue":"0","ShopItemID":"28150","sFile":"ULS.swf","EnhID":"0","iStk":"1","sDesc":"The parasite infecting this armor was created especially for Dage\'s Legion. Now truly be one with the Dark Lord.","bHouse":"0","bUpg":"0","iReqCP":"0","sName":"Legion Symbiote","iQSindex":"-1"}],"sField":"","ShopID":"216","bStaff":"0","bHouse":"0","Location":"Menu","iIndex":"-1","sName":"Undead Legion Shop"},"cmd":"loadShop"}}}',
        );
        ...
        $this->assertSame($item->id, 47_482);
        $this->assertSame($item->name, 'Legion Symbiote');
        $this->assertSame(
            $item->description,
            'The parasite infecting this armor was created especially for Dage\'s Legion. Now truly be one with the Dark Lord.',
        );
